...
suite "dynamic vector 32 operations":
  ...
  test "in place vector sum":
    let N = 10
    var v1 = randomVector(N, max=1'f32)
    let v2 = randomVector(N, max=1'f32)
    var p1 = v1.gpu()
    let p2 = v2.gpu()
    v1 += v2
    p1 += p2
...
suite "dynamic vector 64 operations":
  ...
  test "in place vector sum":
    let N = 10
    var v1 = randomVector(N, max=1.0)
    let v2 = randomVector(N, max=1.0)
    var p1 = v1.gpu()
    let p2 = v2.gpu()
    v1 += v2
    p1 += p2
